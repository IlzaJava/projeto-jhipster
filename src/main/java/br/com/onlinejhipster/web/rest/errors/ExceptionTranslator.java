package br.com.onlinejhipster.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.com.onlinejhipster.service.EmailAlreadyUsedException ||
            ex instanceof br.com.onlinejhipster.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof br.com.onlinejhipster.service.InvalidPasswordException
